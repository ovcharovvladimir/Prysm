...
import (
	...
	testpb "github.com/ovcharovvladimir/Prysm/proto/testing"
...
func TestRegisterTopic_WithoutAdapters(t *testing.T) {
	...
	t.Skip("Currently failing to simulate incoming p2p messages. See github.com/ovcharovvladimir/Prysm/issues/488")
	s, err := NewServer()
	if err != nil {
