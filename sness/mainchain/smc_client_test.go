...
// Verifies that VRCCLient implements the sharding Service inteface.
var _ = shared.Service(&VRCClient{})

// mockClient is struct to implement the vrcClient methods for testing.
...
// TestWaitForTransaction tests the WaitForTransaction function in the vrcClient, however since for testing we do not have
