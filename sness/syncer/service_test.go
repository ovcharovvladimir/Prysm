...
func TestStop(t *testing.T) {
	...
	syncer, err := NewSyncer(params.DefaultConfig, &mainchain.VRCClient{}, server, shardChainDB, shardID)
	if err != nil {
...
func TestHandleCollationBodyRequests(t *testing.T) {
	...
	syncer, err := NewSyncer(params.DefaultConfig, &mainchain.VRCClient{}, server, shardChainDB, 0)
	if err != nil {
