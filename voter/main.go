...
import (
	...
	"github.com/ovcharovvladimir/Prysm/voter/node"
...
`
	...
	app := cli.NewApp()
	app.Name = "voter"
	app.Usage = `launches an Essentia voter client that interacts with a beacon chain, starts proposer services, shardp2p connections, and more
`
